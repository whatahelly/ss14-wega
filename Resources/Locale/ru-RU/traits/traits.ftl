...
trait-french-desc = Ваш акцент, похоже, имеет определённый «je ne sais quoi». Работает только с английским.
trait-spanish-name = Испанский акцент
trait-spanish-desc = Hola señor, как пройти в la biblioteca. Работает только с английским.
