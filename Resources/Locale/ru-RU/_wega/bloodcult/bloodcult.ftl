...
select-constuct-harvester = Жнец
...
blood-ritual-warning = Был обнаружен сдвиг пространства { $location }. Прекратите распространение аномалии всеми доступными средствами. Ожидаемое расширение через 45 секунд.
