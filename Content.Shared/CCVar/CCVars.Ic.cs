...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<bool> FlavorText =
        CVarDef.Create("ic.flavor_text", true, CVar.SERVER | CVar.REPLICATED); // Corvax-Wega

    /// <summary>
    ///     Sets the maximum length for flavor text (character descriptions).
    /// </summary>
    public static readonly CVarDef<int> MaxFlavorTextLength =
        CVarDef.Create("ic.flavor_text_length", 1024, CVar.SERVER | CVar.REPLICATED); // Corvax-Wega-Edit
